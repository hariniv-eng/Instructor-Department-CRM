...
import DarwinFullRosterBreakdownPage from '@/pages/darwin-full-roster-breakdown';
...
const ADMIN_ONLY_PATHS = ['/darwin-breakdown', '/darwin-full-roster-breakdown', '/teachos-breakdown', '/uploads', '/exits'];
          ...
          <Guard>
            <AppShell>
              <Switch>
                ...
                <Route path="/darwin-full-roster-breakdown" component={DarwinFullRosterBreakdownPage} />
